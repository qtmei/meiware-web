<?php
	...
	if($_POST)
	{
		...
		if($usernameres == 0 && $password == $passwordconfirm)
		{
			...
			$sta->execute(array(':username' => $username, ':password' => password_hash($password, PASSWORD_DEFAULT)));
...
<html>
	...
	<nav>
		<a href="users.php">users</a>[<a href="login.php">login</a>/<a href="register.php">register</a>]
	</nav>
